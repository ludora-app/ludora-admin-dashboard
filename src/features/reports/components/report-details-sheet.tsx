...
export function ReportDetailsSheet({
  ...
  // Detailed Query - Single user's report history (enabled only when sheet is open)
  const {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="sm:max-w-md w-full overflow-y-auto bg-card shadow-xl">
        <SheetHeader className="border-b border-secondary pb-4 mb-4">
          <SheetTitle className="text-xl font-extrabold text-text-primary">
